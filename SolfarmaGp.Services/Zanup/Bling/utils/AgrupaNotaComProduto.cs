using System.Data;
using static SolfarmaGp.Services.Zanup.Bling.DtoLinhaDataTableDocumento;

namespace SolfarmaGp.Services.Zanup.Bling.utils
{
    public class AgrupaNotaComProduto
    {
        ...
        public List<List<ItemDocumento>> Execute(List<DataRow> listRow)
        {
            var lista = listRow

...
using ERP_FISCAL.Repositories.MetaComissaoFarmaRepositories;
using System;
...
namespace ERP_FISCAL.Controller.MetaComissaoFarmaController
{
    ...
    public class MetaComissaoFarmaController
    {
        public async Task<DataTable> BuscaComissaoMetas(ObjetoPesquisa objPesquisa) 
        {
            MetaComissaoFarmaRepositories metaComissao = new MetaComissaoFarmaRepositories();
            DataTable retorno = await metaComissao.ConsultaComissaoMetasFarma(objPesquisa);

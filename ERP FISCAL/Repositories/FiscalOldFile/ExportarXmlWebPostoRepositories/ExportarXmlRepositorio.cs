...
namespace ERP_FISCAL.Repositories.ExportarXmlRepositories
{
    ...
    {
        public async Task<DataTable> ExportaXmlPostoLago(DateTime dataInicio, DateTime dataFim, string localExportacao, string modeloDocumento, int exportarTudo, IProgress<string> progress = null)
        {

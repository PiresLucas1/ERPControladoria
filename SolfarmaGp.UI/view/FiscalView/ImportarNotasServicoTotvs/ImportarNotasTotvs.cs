        ...
        private async void btnListaNotas_Click(object sender, EventArgs e)
        {
            ...
            if (coBoxTipeFilter.SelectedIndex == 0) // datepicker
            {
                ...
                try
                {
                    ...
                    ConsultaNotasServico exportServiceNotes = new ConsultaNotasServico();

                    DataTable notas = await exportServiceNotes.Executar(dataInicio, dataFim, Convert.ToInt32(txtBoxColigada.Text), cbLancadasNoERP.Checked);

...
namespace SolfarmaGp.Repositorios.Fiscal.ImportaDadosBigParaTotvs.ConsultaNaturezaFiscal.ConsultaPorOcorrencia
{
    public class ConsultaNaturezaPorOcorrencia
    {
        public DataTable Consultar(string valor, int codColigada, bool valorEmNumero)
        {
